...
public class BibimMyeonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bibim_myeon);
        setTitle("비빔면");
        ...
        btn_play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isBinding) {
                    Intent intent = new Intent(BibimMyeonActivity.this, MyRamenTimerCounterService.class);
                    intent.putExtra("TIME",180);//180초 끝나면 카운팅 끝을 하고 싶을때
        ...
        class GetCountThread implements Runnable {
            ...
            public void run() {
                ...
                if (isBinding) {
                    ...
                    BibimMyeonActivity.this.unbindService(connection);
                }
                isBinding = false;
        }
    }
