...
public class SinRamenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sin_ramen);
        setTitle("신라면");
        ...
        btn_play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SinRamenActivity.this, MyRamenTimerCounterService.class);
                intent.putExtra("TIME", 300);//180초 끝나면 카운팅 끝을 하고 싶을때
        ...
        class GetCountThread implements Runnable {
            ...
            public void run() {
                ...
                if (isBinding) {
                    ...
                    SinRamenActivity.this.unbindService(connection);
                }
                isBinding = false;
            }
        }
